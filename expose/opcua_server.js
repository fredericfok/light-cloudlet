...
var server = new opcua.OPCUAServer({
    port: process.env.PORT || 4334, // the port of the listening socket of the server
    resourcePath: "lightstream/server", // this path will be added to the endpoint resource name
     buildInfo : {
        productName: "LightStreamServerV1",
        buildNumber: "1",
        buildDate: new Date(2015,3,31)
    }
});
